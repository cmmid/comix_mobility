...
plw = ggplot(mob_cnt) +
  ...
  geom_line(aes(x = workplaces, y = mob1, col = "mob"), linewidth = 0.8) +
  geom_ribbon(aes(x = workplaces, ymin = w1_lwr, ymax = w1_uppr, fill = "mob"), alpha = 0) +
  geom_line(aes(x = workplaces, y = mob2, col = "mob2"), linewidth = 0.8) +
  geom_ribbon(aes(x = workplaces, ymin = w2_lwr, ymax = w2_uppr, fill = "mob2"), alpha = 0) +
  geom_point(aes(x = workplaces, y = work), size = 2) + #ylim(0, 1.6) + 
  scale_x_continuous(breaks = c(seq(0, 0.8, by = 0.2)), limits = c(0.3, 0.8)) + 
  scale_y_continuous(breaks = c(seq(0, 1.5, by = 0.5)), limits = c(0, 1.6)) +
  labs(x = "Google Mobility ''Workplaces'' Visits", col = " ",
       y = "Mean ''Work'' Contacts", fill = "Model Type") +
  scale_color_manual(breaks = c("mob", "mob2", "lin", "quad"),
                     values = c("#CC79A7", "#D55E00", "#0072B2", "#F0E442"),
  ...
  scale_fill_manual(breaks = c("mob", "mob2", "lin", "quad"),
                    values = c("#CC79A7", "#D55E00", "#0072B2", "#F0E442"),
                    labels = c("Mobility", "Mobility Squared", 
                               "Linear Regression", "Quadratic Regression")) +
  guides(color = guide_legend("Model Type"),
         fill = guide_legend("Model Type")) 
...
plo = ggplot(mob_cnt) +
  ...
  geom_line(aes(x = predictor, y = mob1, col = "mob"), linewidth = 0.8) +
  geom_ribbon(aes(x = predictor, ymin = o2_lwr, ymax = o2_uppr, fill = "mob"), alpha = 0) +
  geom_line(aes(x = predictor, y = mob2, col = "mob2"), linewidth = 0.8) +
  geom_ribbon(aes(x = predictor, ymin = o2_lwr, ymax = o2_uppr, fill = "mob2"), alpha = 0) +
  geom_point(aes(x = predictor, y = other), size = 2) + #ylim(0, 2.75) +
  scale_x_continuous(breaks = c(seq(0, 0.8, by = 0.2)), limits = c(0.35, 0.8)) + 
  scale_y_continuous(breaks = c(seq(0, 2.5, by = 0.5)), limits = c(0, 2.75)) +
  labs(x = "Google Mobility ''Other'' Visits", col = " ", 
       y = "Mean ''Other'' Contacts", fill = "Model Type") +
  scale_color_manual(breaks = c("mob", "mob2", "lin", "quad"),
                     values = c("#CC79A7", "#D55E00", "#0072B2", "#F0E442"),
